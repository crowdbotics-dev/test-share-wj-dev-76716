"""
Django settings for test_share_wj_dev_76716 project.
...
ROOT_URLCONF = 'test_share_wj_dev_76716.urls'
...
WSGI_APPLICATION = 'test_share_wj_dev_76716.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_share_wj_dev_76716 API",
    "DESCRIPTION": "API documentation for test_share_wj_dev_76716 App",
    "VERSION": "v1",
}
